...
// Methoden
	...
	public String kundenListeSortiertNachVorname(Model model) {
		model.addAttribute("kundenListe", pVerwaltung.findKundeSortNachVorname());
		return "kunden";
	}
	...
	public String kundenListeSortiertNachNachname(Model model) {
		model.addAttribute("kundenListe", pVerwaltung.findKundeSortNachName());
		return "kunden";
	}
	...
	public String sucheNachVorname(Model model, @RequestParam("vorname") String vorname) {
		model.addAttribute("kundenListe", pVerwaltung.sucheKunde(vorname));
		return "kunden";
	}
